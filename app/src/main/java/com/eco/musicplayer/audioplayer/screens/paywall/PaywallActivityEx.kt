...
import com.eco.musicplayer.audioplayer.constants.iap.ConstantsProductID
...
fun PaywallActivity.setOnClicks() {
    binding.btnClose.setOnClickListener {
        ...
        DVDLog.showLog("123123getIsPremium() - ${getIsPremium()}")
    ...
    with(binding) {
        btnMonthly.setOnClickListener {
            selectPosition = 1; updateItem(); updatePlanSelectionBasedOnPurchases()
        }
        btnYearly.setOnClickListener {
            selectPosition = 2; updateItem(); updatePlanSelectionBasedOnPurchases()
        }
        btnLifetime.setOnClickListener {
            selectPosition = 3;updateItem();updatePlanSelectionBasedOnPurchases()
        }
...
fun PaywallActivity.registerListenerInterstitial() {
...
private fun PaywallActivity.setupSkuDetails(
    ...
    when {
        skuDetails.freeTrialPeriod.isNotEmpty() -> {
            tv3.setVisibleText(getString(R.string.free))
...
private fun PaywallActivity.getButtonText(currentSubscription: String?): String {
    ...
    Log.d(
        TAG,
        "getButtonText: selectedProduct=$selectedProduct, currentSubscription=$currentSubscription"
    )
